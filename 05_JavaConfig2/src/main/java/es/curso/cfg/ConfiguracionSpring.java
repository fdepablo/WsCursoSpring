...
//Al darlo todo de alta mediante configuracion java podriamos quitar el @Configuration
@Configuration
public class ConfiguracionSpring {
	...
	//La manera basica de proceder seria mediante metodos anotados con @Bean
	//Spring recorrera todos los metodos de la clase, y aquellos metodos con 
	//dicha anotacion, lo ejecutara y el objeto devuelto lo dara de alta en el 
	//contexto. El id que le asignara sera el nombre del metodo (por defecto).
	...
	@Bean(value="directorBean")//id=directorBean
	@Scope("prototype")
	...
	//si no hubiera ninguno, arrojar�a una excepci�n
